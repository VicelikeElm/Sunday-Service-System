@echo off
setlocal
title Sunday Service System - SIGNED Windows Release Build v3.1.6

cd /d C:\Church\SermonAI

echo.
echo ================================================================
echo SUNDAY SERVICE SYSTEM - SIGNED WINDOWS RELEASE v3.1.6
echo ================================================================
echo.
...
echo   C:\Church\SermonAI\update-output\SundayServiceSystem-Update-v3.1.6.sssupdate
echo.
echo Installer, when Inno Setup is installed:
echo   C:\Church\SermonAI\installer-output\SundayServiceSystem-Setup-v3.1.6.exe
echo.
