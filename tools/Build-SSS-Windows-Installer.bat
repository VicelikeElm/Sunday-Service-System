@echo off
setlocal
title Sunday Service System - SIGNED Windows Release Build v3.1.5

cd /d C:\Church\SermonAI

echo.
echo ================================================================
echo SUNDAY SERVICE SYSTEM - SIGNED WINDOWS RELEASE v3.1.5
echo ================================================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Church\SermonAI\tools\Check-SSS-Packaged-Build-Locks.ps1"
...
"%PROD_PYTHON%" core\build_sss_windows.py
if errorlevel 1 goto :fail
...
echo   C:\Church\SermonAI\update-output\SundayServiceSystem-Update-v3.1.5.sssupdate
echo.
echo Installer, when Inno Setup is installed:
echo   C:\Church\SermonAI\installer-output\SundayServiceSystem-Setup-v3.1.5.exe
echo.
